...
/**
 * 应用内切换语言
 * LanguageUtils.applyLanguage(Locale.US, "")  切换英文
 * LanguageUtils.applySystemLanguage("")    切换系统语言
 * LanguageUtils.applyLanguage(Locale.SIMPLIFIED_CHINESE, "com.blankj.main.pkg.MainActivity")  mainactivity切换中文
 */
